...
namespace XPW.Utilities.CustomExceptions {
     ...
     public class RepositoryException : Exception {
          ...
          public RepositoryException(string errorCode, string errorType, string message, string errorbaseFile) : base(string.Format("Error at : {0}", message)) {
               ...
               string fileName = errorbaseFile + DateTime.Now.ToString("HH-mm-ss") + ".json";
